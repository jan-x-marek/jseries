...
public class GenericArrayTest {
    ...
    public void testAsList() {
        GenericArray<Double> a = GenericArray.ofNoClone(-1.0, 1.0, 2.0, 0.0);
    ...
    @Test
    public void testMap() {
        GenericArray<Double> array = GenericArray.ofNoClone(1.0, 2.0);
        Array<Double> mapped = array.map(d -> d + 1);
        assertThat(mapped.asList()).containsExactly(2.0, 3.0);
    }
